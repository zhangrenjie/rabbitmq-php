...
try {
    ...
    //定义死信交换机和死信队列
    $dlxExchangeName = 'dxl_exchange_2';
    ...
    //定义死信队列
    $dlxQueueName = 'dxl_message_queue_2';
    $passive = false;
    $durable = true;//持久化交换机
    $exclusive = false;
    $autoDelete = false;
    ...
    $arguments->set('x-max-length', 10);//设置队列最大长度
